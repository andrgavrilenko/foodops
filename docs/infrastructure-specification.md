...
| **Chrome Extension** | JavaScript/TypeScript | Автоматизация покупки на foodie.fi (S-Market), парсинг каталога |
...
3. Extension автоматизирует добавление товаров в корзину на foodie.fi
4. Статус покупки обновляется через Backend API

**Фоновые процессы:**
1. Периодический парсинг каталога foodie.fi (через очередь BullMQ)
...
*Документ подлежит ревизии при значительных изменениях в требованиях проекта или при переходе между фазами.*
