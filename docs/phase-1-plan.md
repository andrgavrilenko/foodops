...
**Week 2 — Restrictions + Preferences (Sprint 1)** 6. Day 1-2: Dietary restrictions endpoints + tests 7. Day 2-3: Medical restrictions endpoints + tests 8. Day 3-4: Preferences endpoints + tests 9. Day 5: Integration tests (full user flow: register → create family → add members → add restrictions)

**Week 3 — Polish + Docs (Sprint 2)** 10. Day 1: OpenAPI/Swagger docs generation (@fastify/swagger) 11. Day 2: Error handling audit (ensure all error codes from tech spec are implemented) 12. Day 3: Performance testing (100 concurrent requests to /family endpoint) 13. Day 4: Security audit (SQL injection, XSS, CSRF checks) 14. Day 5: Code review + bug fixes
