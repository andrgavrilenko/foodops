...
3. **Chrome Extension** -- автоматическое добавление товаров из списка в корзину на foodie.fi с отчётом о результатах (FR-300 -- FR-323, US-030 -- US-035).
...
- **Начальный магазин:** S-Market (foodie.fi), доля рынка S-Group -- 48,8%
